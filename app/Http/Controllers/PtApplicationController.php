...
class PtApplicationController extends Controller
{
    function create_certificate($id, $application_id)
    {
        ...
        return redirect()->route('proficiency-testing.applicants.showApplication', ['id' => $id, 'application_id' => $application_id])->with('message', 'Certificate successfully created.')->with('classname', 'alert-success');
    }
    ...
    function verify_certificate($id, $application_id)
    {
        ...
        return redirect()->route('proficiency-testing.applicants.showApplication', ['id' => $id, 'application_id' => $application_id])->with('message', 'Certificate verified successfully.')->with('classname', 'alert-success');
    }
    ...
    function approve_certificate($id, $application_id)
    {
        ...
        return redirect()->route('proficiency-testing.applicants.showApplication', ['id' => $id, 'application_id' => $application_id])->with('message', 'Certificate approved successfully.')->with('classname', 'alert-success');
    }
}
