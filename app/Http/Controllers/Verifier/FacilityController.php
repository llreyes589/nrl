...
class FacilityController extends Controller
{
    ...
    function certificate(Request $request, $key)
    {
        ...
        if ($certificate->approved_by_details) {
            ...
            $pdf::Image(asset('storage/' . $settings->director->signature), 137, 253, 40, 10, 'PNG', '', '', true, 300, '', false, false, 0, false, false, false);
        }
        ...
        $head_html = '
            ...
            <tr style="text-align:center;">
                ...
                <td style="width:50%">
                    <p class="name">' . $settings->director->name . '</p>
                    <p class="designation">' . $settings->director->position . '</p>
                    <p class="designation">' . $settings->director->designation . '</p>
                </td>
            </tr>            
        </table>            
        ';
            ...
            <table >
                ...
                <tr style="text-align:center;" >
                    ...
                    <td style="width:80%">
                        ...
                        <p style="font-size: 11pt;">
                            ' . $certificate->ptApplication->user->address . '
                        </p>
                        <br>
                ...
                <tr style="text-align:center;" >
                    ...
                    <td style="width:90%">
                        ...
                        <p style="font-size: 20pt; font-weight: bold;">"' . $certificate->ptApplication->pt->cert_setting->certificate_theme . '" </p>
                        <br>
                        <p class="cursive">
                            Given this ' . $given . '
                        </p>
