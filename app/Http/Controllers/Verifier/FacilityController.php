...
class FacilityController extends Controller
{
    ...
    function certificate(Request $request, $key)
    {
        ...
        $pdf = new PDF();
        $qr = QrCode::format('png')->size(300)->merge('http://1.bp.blogspot.com/-YSy27PtRhnM/TVOIUvjmCsI/AAAAAAAAAKE/dyvKbvJxN4M/s1600/nrl+eamc+logo.jpg', .14, true)->generate(\route('verifyCertificate', ['key' => $key]));
        ...
        if ($certificate->approved_by_details) {
            ...
            $pdf::Image(asset($settings->director_signature_path), 137, 247, 40, 20, 'PNG', '', '', true, 300, '', false, false, 0, false, false, false);
        }
